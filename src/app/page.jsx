  ...
  return(
    <>
      ...
      <div className="mt-60 flex flex-col items-center justify-center">
        ...
        <p className="text-center text-center max-w-screen-md w-full overflow-x text-balance mt-12 font-bold text-3xl subpixel-antialiased font-michroma">"Tomorrow's Technology for Today's World!"</p>
